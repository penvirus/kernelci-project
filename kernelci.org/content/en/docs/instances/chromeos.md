...
In case you want to submit a patch for ChromeOS, please send a github PR, with
commit title in the format:

CHROMEOS **filename**: Describe your patch
...
./kci_test generate --lab-config=lab-collabora --install-path=_install_\
 ...
 --storage=https://storage.chromeos.kernelci.org/\
  --plan=cros-flash
```
Firmware loading can take quite a long time, 10-15 minutes, and successful 
